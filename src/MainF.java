...
public class MainF extends JFrame {
    ...
    private static String echo = "no text";

    public static String getS() {
        return s;
    }

    public static void setS(final String s) {
        MainF.s = s;
    }
    ...
    public static void setEcho(final String echo) {
        MainF.echo = echo;
    }
    ...
    public void go() {
        ...
        readFile.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                String filename="";
                if(result==0){   //此处修复一个小bug。未修改前，点击read a file 按钮但是不选择文件就退出会报nullpointerexception； 因而，加入判断，当未选择文件时跳过下面两行代码
                    filename= ch.getSelectedFile().getPath();
                    Lab1.setGra(Lab1.createDirectedGraph(filename));
        ...
        showGraph.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                Lab1.showDirectedGraph(Lab1.getGra());
            }
        });
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                button.addActionListener(new ActionListener() {
                    public void actionPerformed(final ActionEvent e) {
                        ...
                        label.setText(Lab1.queryBridgeWords(Lab1.getGra(), s1, s2));
                    }
                });
            }
        });
        newText.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                button.addActionListener(new ActionListener() {
                    public void actionPerformed(final ActionEvent e) {
                        String s1 = field1.getText();
                        label.setText(Lab1.generateNewText(Lab1.getGra(), s1));
                    }
                });
            }
        });
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                button.addActionListener(new ActionListener() {
                    public void actionPerformed(final ActionEvent e) {
                        String s1 = field1.getText();
                        String s2 = field2.getText();
                        label.setText(Lab1.calcShortestPath(Lab1.getGra(), s1, s2));
                    }
                });
            }
        });
